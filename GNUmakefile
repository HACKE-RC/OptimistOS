...
runm: optimist.iso
#	qemu-system-x86_64.exe -M q35 -m 2G -cdrom optimist.iso -boot d
	qemu-system-x86_64.exe -M q35 -m 4G -cdrom optimist.iso -boot d -smp cores=2
...
run-uefi: ovmf-x64 optimist.iso
	qemu-system-x86_64 -M q35 -m 2G -bios ovmf-x64/OVMF.fd -cdrom optimist.iso -boot d
...
optimist.iso: limine kernel
	...
	xorriso -as mkisofs -b limine-cd.bin \
		...
		iso_root -o optimist.iso
	limine/limine-deploy optimist.iso
	rm -rf iso_root
